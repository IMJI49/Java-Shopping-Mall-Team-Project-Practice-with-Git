						...
						case "2":
							...
							do {
								...
								case "1":
									// 내 정보 조회
									System.out.println("\n========  내 정보 조회  ==========");
									System.out.print("정보를 조회하기 전에 비밀번호를 입력하세요: ");
									String infoPassword = scanner.nextLine();
									if (!userService.passwordCheck(manager, infoPassword)) {
										continue;
									}
...
//												e.printStackTrace();
								...
								case "3":
									...
									try {
										...
										// 6. 주소 검증
										ValidationUtils.requireNotNullAndEmpty(address, "주소를 입력해 주세요.");
										ValidationUtils.requireMaxLength(address, 50, "주소는 50자 이내로 입력해 주세요.");
										System.out.print("변경할 이메일을 입력하세요: ");
										String email = scanner.nextLine();
										// 4. 이메일 검증
										ValidationUtils.requireNotNullAndEmpty(email, "이메일을 입력해 주세요.");
										...
										// 5. 전화번호 검증
										ValidationUtils.requireNotNullAndEmpty(phoneNumber, "전화번호를 입력해 주세요.");
						...
						case "4":
							...
							do {
								...
								case "3":
									System.out.println("\n========  회원 상세 정보  =========");
									System.out.print("정보를 확인할 회원의 id를 입력하세요: ");
...
//												e.printStackTrace();
								...
								case "3":
									...
									try {
										System.out.print("변경할 주소를 입력하세요: ");
										String address = scanner.nextLine();
										ValidationUtils.requireMaxLength(address, 50, "주소는 최대 50자입니다.");
										System.out.print("변경할 이메일을 입력하세요: ");
										String email = scanner.nextLine();
										ValidationUtils.requireNotNullAndEmpty(email, "이메일을 입력해 주세요.");
										if (!(email.contains("@") && email.contains("."))) {
										...
										userService.updateAddress(customer.getId(), infoPassword, address);
										userService.updateEmail(customer.getId(), infoPassword, email);
										userService.updatePhone(customer.getId(), infoPassword, phoneNumber);
									} catch (ValidationException e) {
										System.out.println(e.getLocalizedMessage());
									}
									System.out.println("변경이 완료되었습니다.");
	...
	public void itemController(Scanner scanner) throws ShoppingMallException {
		while (true) {
			...
			case "2":
				/*
				 * 가격, 설명 제품 명 받고 제품 명을 통한 item받아서 set으로 수정
				 */
				System.out.println("\n==========  상품 수정  ===========");
				...
				System.out.print(
						"상품 가격, 상품 개수, 상품 설명을 변경 할 수 있습니다.\n 어떤 것을 변경하시겠습니까?\n가격, 개수, 설명을 입력 해 주세요(예. 개수, 가격)\n 변경 사항이 없을 시 n을 입력해주세요 :");
			...
			case "3":
				System.out.println("\n=========   상품 삭제   ==========");
				System.out.print("삭제할 상품의 이름을 검색하세요, 삭제 하지 않을 경우 n을 입력 해 주세요: ");
				...
				FileManagement.writeToFile(Constants.PRODUCT_DATA_FILE,
						userService.deleteItem(deleteItem).values().stream().toList());
			...
			case "4":
				...
				System.out.print("상품 개수를 증가시키겠습니까? 감소시키겠습니까?(추가, 감소), n을 입력하면 취소 됩니다 :");
